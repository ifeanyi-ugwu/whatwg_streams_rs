...
use crate::dlc::ideation::d::StreamResult;

use super::{byte_source_trait::ReadableByteSource, errors::StreamError};
...
{
    pub fn new(source: Source, high_water_mark: usize) -> Arc<Self> {
        Arc::new(Self {
...
//#[async_trait]
pub trait ByteStreamStateInterface: Send + Sync {
